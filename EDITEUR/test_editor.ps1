...
Invoke-Gate -Name "python-lint-v1" -WorkingDirectory $projectRoot -Command "uv" -Arguments @("run", "ruff", "check", "backend/src/crea_zik/api.py", "backend/src/crea_zik/composition_dsp.py", "backend/src/crea_zik/compositions.py", "backend/src/crea_zik/errors.py", "backend/src/crea_zik/gallery.py", "backend/src/crea_zik/models.py", "tests/test_api.py", "tests/test_api_robustness.py", "tests/test_compositions.py", "tests/test_editor_sequencer.py", "tests/test_schema_fuzz.py")
Invoke-Gate -Name "python-types-v1" -WorkingDirectory $projectRoot -Command "uv" -Arguments @("run", "mypy", "backend/src/crea_zik/api.py", "backend/src/crea_zik/composition_dsp.py", "backend/src/crea_zik/compositions.py", "backend/src/crea_zik/errors.py", "backend/src/crea_zik/gallery.py", "backend/src/crea_zik/models.py")
Invoke-Gate -Name "composition-domain" -WorkingDirectory $projectRoot -Command "uv" -Arguments @("run", "pytest", "tests/test_api.py", "tests/test_api_robustness.py", "tests/test_compositions.py", "tests/test_editor_sequencer.py", "tests/test_foundation.py", "tests/test_composer.py")

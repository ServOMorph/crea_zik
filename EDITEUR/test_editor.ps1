...
Invoke-Gate -Name "composition-domain" -WorkingDirectory $projectRoot -Command "uv" -Arguments @("run", "pytest", "tests/test_api.py", "tests/test_api_robustness.py", "tests/test_compositions.py", "tests/test_foundation.py", "tests/test_composer.py")

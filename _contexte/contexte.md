...
La phase 1 fournit les schémas métier v1, migrations de lecture, validation, provenance, CLI, moteur Csound et API.
La tranche UI de phase 2 lance projets, galerie rendable, Sound Designer minimal et file de jobs SSE sur `8002`/`5174`.
Les jobs restent visibles jusqu’à leur état terminal, s’annulent sans bloquer la file et les WAV se lisent via le proxy `/projects`.
Restent les tests CLI, erreurs/logs structurés, manifeste d’export, QA et l’observation manuelle de l’annulation longue.
